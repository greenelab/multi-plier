...
colnames(mcp.melt) <- c("Cell_type", "Sample", "MCP_estimate")
...
neutro.lv.df <- as.data.frame(nares.b[3 ,])
...
neutro.df <- 
  dplyr::inner_join(x = dplyr::filter(mcp.melt, Cell_type == "Neutrophils"),
                    y = neutro.lv.df, by = "Sample")
```
