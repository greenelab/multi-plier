...
```{r}
sle.plot <- LVScatter("LV87") +
  ggplot2::labs(title = "SLE WB PLIER model") +
  ggplot2::theme(plot.title = ggplot2::element_text(hjust = 0.5, 
                                                    face = "bold")) +
  ggplot2::annotate("text", x = -1, y = 15, label = "r-squared = 0.29")
```

```{r}
recount.plot <- LVScatter("recount2_LV603") +
  ggplot2::labs(title = "recount2 PLIER model") +
  ggplot2::theme(plot.title = ggplot2::element_text(hjust = 0.5, 
                                                    face = "bold")) +
  ggplot2::annotate("text", x = -0.375, y = 15, label = "r-squared = 0.36")
```
