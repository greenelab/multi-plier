...
```{r}
series.mat.file <- file.path(exprs.dir,
                             "GSE50021_series_matrix.txt")
...
The sample-data relationship files (specifically, their column names) are 
pretty tidyverse-unfriendly.
...
readr::write_tsv(cleaned.meta.df, 
                 path = file.path(sample.info.dir, 
                                  "E-GEOD-26575_cleaned_metadata.tsv"))
```
