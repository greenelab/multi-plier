...
```{r}
head(sort(recount.plier$Z[, 53], decreasing = TRUE), 50)
```
...
```{r}
head(sort(recount.plier$Z[, 63], decreasing = TRUE), 50)
```
...
```{r}
head(sort(recount.plier$Z[, 139], decreasing = TRUE), 50)
```
...
```{r}
head(sort(recount.plier$Z[, 332], decreasing = TRUE), 50)
```
...
```{r}
head(sort(recount.plier$Z[, 346], decreasing = TRUE), 50)
```
...
```{r}
head(sort(recount.plier$Z[, 631], decreasing = TRUE), 50)
```
...
```{r}
head(sort(recount.plier$Z[, 887], decreasing = TRUE), 50)
```
...
```{r}
head(sort(recount.plier$Z[, 909], decreasing = TRUE), 50)
```
