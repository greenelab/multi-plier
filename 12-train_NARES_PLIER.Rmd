...
This dataset (`n = 77`) contains nasal brushing samples from patients with 
...
#### What proportion of the pathways input into the PLIER model are 
significantly associated with at least one LV?
