...
p <- cowplot::plot_grid(baseline.p, lv6.p, align = "h", axis = "b", 
                        rel_widths = c(1.5, 1), labels = c("E", "F"))
p.title <- cowplot::ggdraw() + 
...
```{r}
overall.p <- cowplot::plot_grid(multi.p, mod.p, sle.p, ncol = 1, scale = 0.9)
ggplot2::ggsave(file.path(plot.dir, "IFN-K_supplemental.pdf"), plot = overall.p,
                width = 11, height = 14)
```
