...
tweak display items.
In this notebook, I'll work with the IFN-K trial data.
Specifically, I will replot the baseline data based on 4 groups 
and a single panel looking at the change of expression during treatment 
(at day 112) in whichever module or LV is most representative of Type I 
signaling based on the Chiche, et al. paper or the LV with the highest AUC for 
...
Day112Plot <- function(df,
  ...
  # y.label: y-axis label
  df %>%
    dplyr::mutate(`IFN-level` = factor(`IFN-level`, 
                                       levels = c("Placebo", "IFN-positive",
                                                  "IFN-negative"))) %>%
    ...
    ggplot2::scale_color_manual(values = c("#969696", "#e08214", "#8073ac")) +
