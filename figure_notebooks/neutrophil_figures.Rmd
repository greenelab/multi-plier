...
`07-sle_cell_type_recount2_model` and `14-NARES_MCPcounter`
...
nares.p <- LVScatter(neutro.df = nares.df, lv = "recount_LV603", rsq = 0.90, 
                     x.label = "recount2 LV603", plot.title = "MultiPLIER",
...
```{r}
p <- cowplot::plot_grid(sle.p, recount.p, nares.p, ncol = 3, scale = 0.95,
                   align = "h", labels = "AUTO")
